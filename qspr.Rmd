...
#install.packages(c("plotROC","caret","gbm","bit64","Boruta","clue","coefplot","devtools","e1071","FNN","fastcluster","FactoMineR","FSelector","ggplot2","glmnet","kernlab","pls","PredPsych","Rtsne","randomForest"))
...
preprocessed_rds <- "~/R/desc_all.rds" # cached preprocessed data
```
